...
{\footnotesize
	...
	Представлен новый подход к поиску весов, которые приводят к улучшению точности в задаче взвешенной аппроксимации рядом конечного ранга. Для построения численного метода поиска весов использована теория квадратичной оптимизации. Задача поиска весов сформулирована в нескольких эквивалентных формулировках, каждая из которых используется при построении эффективного и применимого на практике алгоритма.
