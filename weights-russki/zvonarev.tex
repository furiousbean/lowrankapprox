...
Рассмотрим выражение $\varphi^2(C)/2$, где $\varphi(C)$ определено в \eqref{eq:commonw}. Раскроем его, избавимся от константного члена, а множество $\calC$ из \eqref{eq:commonw_cond} обозначим в виде набора линейных ограничений. Получим следующую эквивалентную формулировку:
...
%В таком виде задача становится удобной для использования теории квадратичного программирования \cite{Gavurin1984}. 
