...
Известно (см. \cite{Golyandina.etal2001, Broomhead.King1986, Vautard.etal1992, Elsner.Tsonis1996} и \cite[Chapter 4]{stoica2005spectral}), что для выделения такого рода сигналов хорошо работают методы, основанные на оценке сигнального подпространства (subspace-based methods). Идея методов состоит в следующем: зафиксируем \emph{длину окна} $L$, $1 < L < N$, положим $K = N - L + 1$, и определим \emph{траекторную матрицу} для ряда $\tsS \in \sfX_N$ ($\sfX_N$ --- множество вещественных временных рядов длины $N$):
\begin{equation*}
...
\begin{thebibliography}{1}
	...
	\newblock 2016. "--- jun.
	\newblock \BibUrl{http://dx.doi.org/10.1016/j.spl.2016.06.006}.
