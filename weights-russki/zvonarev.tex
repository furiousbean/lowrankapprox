...
{\footnotesize
	...
	Рассматривается задача взвешенной аппроксимации временным рядом конечного ранга с целью оценивания сигнала. Решается проблема поиска весов, которые приводят к улучшению точности оценок. Построен и теоретически обоснован эффективный метод численного метода поиска весов.
