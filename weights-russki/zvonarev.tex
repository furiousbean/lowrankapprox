...
В дальнейшем, тривиальный случай $\alpha = 1$ опустим.
...
Рассмотрим выражение $\varphi^2(C)/2$, где $\varphi(C)$ определено в \eqref{eq:commonw}. Преобразуем его, избавимся от константного слагаемого, а множество $\calC$ из \eqref{eq:commonw_cond} запишем в виде набора линейных ограничений. Получим следующую эквивалентную формулировку:
...
\begin{enumerate}
	...
	Аналогично, за счёт разрежённости матрицы $\bfA$ можно быстро находить множители Лагранжа.
