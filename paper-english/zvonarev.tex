...
Several new methods are suggested. Questions of convergence, computational complexity and accuracy are considered for the proposed methods. The methods are compared on a numeric example.
\end{abstract}
...
\end{figure}
	...
	\begin{itemize}
		...
		\item
		One iteration of Cadzow iterations is well-known Singular Spectrum Analysis (SSA) method, which can solve significantly wider range of tasks than the iterative method does. Therefore, precision of signal estimation done by one iteration in all described methods is the point of interest together with the limiting value.
		\item
...
%The relation of convergence rate, computational complexity and precision of methods was demonstrated. Also, emphasis was placed on precision of estimate made by one iteration of methods.

%Further work includes extended numeric and analytical research of methods, and achievement of more specific recommendations about relation of computational complexity and precision.
...
This result can be found in \cite[Chapter 6.1]{Golyandina.etal2001}. %This result relates to the precision of first iteration of Cadzow iterations.
