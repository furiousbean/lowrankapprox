...
Figure \ref{fig:rl} shows the best approximation of the actual series $\tsX^*$ obtained by Cadzow($0.2$) algorithm. Dotted line shows actual series, while solid line shows L-rank approximation obtained by the algorithm.
