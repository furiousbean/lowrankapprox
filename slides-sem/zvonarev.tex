...
\begin{frame}
	...
	\end{equation*}
	\begin{itemize}
		%\item Неотрицательно определённая квадр. форма в целевой функции после введения вспомогательной переменной $\Longrightarrow$ эквивалентная задача с положительно определённой формой (фиксируем точку с максимальным весом)
